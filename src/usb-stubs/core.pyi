...
class Device(_objfinalizer.AutoFinalizedObject, Generic[T_DEV, T_DEVH]):
    ...
    def set_interface_altsetting(
        self, interface: Interface | int | None = None, alternate_setting: int | None = None
    ) -> None: ...
    def clear_halt(self, ep: Endpoint | int) -> None: ...
    def reset(self) -> None: ...
    def write(self, endpoint: Endpoint | int, data: DataOrLength, timeout: int | None = None) -> int: ...
    @overload
    def read(self, endpoint: Endpoint | int, size_or_buffer: int, timeout: int | None = None) -> array[int]: ...
    @overload
    def read(self, endpoint: Endpoint | int, size_or_buffer: array[int], timeout: int | None = None) -> int: ...
    def ctrl_transfer(
        self,
        bmRequestType: int,
        bRequest: int,
    ...
    def is_kernel_driver_active(self, interface: int) -> None: ...
